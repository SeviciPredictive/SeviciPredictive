...
public class EstacionesSelectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estaciones_select);
       ...
       /* ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(this.getActivity(), android.R.layout.simple_spinner_item, list);
        ...
        btnList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent mainIntent = new Intent().setClass(getApplicationContext(), ListEstacionActivity.class);
    ...
    public void addListenerOnButton() {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast toast = Toast.makeText(getApplicationContext(), "La estación ha sido añadida a favoritos", Toast.LENGTH_SHORT);
                toast.show();
